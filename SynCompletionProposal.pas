...
begin
  ...
  begin
    case Key of
      ...
      SYNEDIT_DELETE: if Assigned(CurrentEditor) then  begin
    ...
    if  (HandleKey) and (Key = SYNEDIT_RETURN)   then Key:=0;
...
begin
  ...
  begin
    ...
    begin
      ...
      //Canvas.Frame3d(tmpRect, cl3DLight, cl3DDkShadow);
